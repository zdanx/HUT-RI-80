...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function deleteImage(imageId, imageUserId) {
        if (!currentUserId || !db) {
    ...
    function renderGallery(images) {
        ...
        images.forEach(imgData => {
            ...
            imgElement.addEventListener('click', () => {
                fullImageDisplay.src = imgData.url;
                fullImageModalOverlay.classList.remove('hidden');
            });
            ...
            if (currentUserId === imgData.userId) {
                ...
                deleteButton.addEventListener('click', () => {
                    deleteImage(imgData.id, imgData.userId);
                });
    ...
    if (closeFullImageBtn) {
        closeFullImageBtn.addEventListener('click', () => {
            fullImageModalOverlay.classList.add('hidden');
        });
        fullImageModalOverlay.addEventListener('click', (event) => {
            if (event.target === fullImageModalOverlay) {
                fullImageModalOverlay.classList.add('hidden');
            }
        });
    }
